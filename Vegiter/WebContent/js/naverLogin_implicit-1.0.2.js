...
BANNER_SMALL_TYPE = 2;
BANNER_BIG_TYPE = 3;
BANNER_USER_TYPE = 4; //161228 사용자 추가
//버튼 색깔에 대한 정의
...
/*
		...
		else if	(this.button_type == BANNER_USER_TYPE) //161228 사용자 추가
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor' class='sns naver'><b class='wtico'></b>로그인</a>";
		}
...
*/
		naver_login(naver_id_login_url);
 ...
 */
	...
	this.get_naver_userprofile = function(callback_func1) {
		...
		success: function (result) {
			...
			inner_profileParams.name		  = result.response.name ; //161228 사용자 추가
			eval(callback_func1);
		},
