...
<script
	src="<%=request.getContextPath()%>/js/naverLogin_implicit-1.0.2.js"></script>
	...
	<section id="login">
		...
		<form onsubmit="return login()"
			...
			<div id="btn">
				...
				<input type="text" class="input-info" placeholder="아이디" id="userId"
					name="userId"><br> <input type="password"
					class="input-info" placeholder="비밀번호" id="userPwd" name="userPwd">
			</div>
		...
		<div id="other-div">
			<span class="other" id="findId"><a
				href="<%=request.getContextPath()%>/findId.me">아이디 찾기</a></span> <span
				class="other" id="findPwd"><a
				href="<%=request.getContextPath()%>/findPwd.me">비밀번호 찾기</a></span> <span
				class="other" id="enroll"><a
				href="<%=request.getContextPath()%>/enrollForm.me">회원가입</a></span>
		</div>
	</section>
