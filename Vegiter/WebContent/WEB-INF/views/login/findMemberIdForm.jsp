...
<body>
	...
	<div id="findArea">
		...
		<br><br>
		<div class="text-center"><input type="submit" class="btn btn-success findBtn" id="btn1" value="로그인" onclick="loginPage();"></div>
		<br><br>
		<div class="text-center"><input type="submit" class="btn btn-success findBtn" id="btn1" value="홈으로" onclick="homePage();"></div>
	</div>
