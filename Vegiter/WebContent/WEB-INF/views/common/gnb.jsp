...
<body>
	<header class="gnb">
		<nav class="gnb-nav">
			<ul>
				...
				<li class="gnb-nav-list" id="about" onclick="location.href='<%= request.getContextPath() %>/aboutPage.me'">About
					<div class="sub-gnb">
						<ul class="sub-gnb-ul">
							<li class="sub-gnb-li" onclick="location.href='<%= request.getContextPath() %>/aboutPage.me'">Vegiter소개</li>
							<li class="sub-gnb-li">공지사항</li>
							<li class="sub-gnb-li">문의사항</li>
						</ul>
					</div>
				</li>
	...
	<script>
		$('#about').focusin(function(){
			$('.sub-gnb').css('display','inline-block');
		});
		function mainPage() {
