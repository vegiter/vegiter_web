...
public class Board {
<<<<<<< HEAD:Vegiter/src/board/model/vo/Board.java
   ...
   public String toString() {
      return "Board [board_no=" + board_no + ", board_code=" + board_code + ", mem_id=" + mem_id + ", board_title="
            ...
            + board_count + ", board_like=" + board_like + ", board_com=" + board_com + ", board_cate=" + board_cate
...
>>>>>>> jinsik:src/board/model/vo/Board.java
